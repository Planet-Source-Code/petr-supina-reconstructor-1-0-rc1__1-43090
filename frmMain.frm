...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fraResampling 
      ...
      Begin VB.ComboBox cboResampler 
         Height          =   315
         ItemData        =   "frmMain.frx":F8B6
         Left            =   120
         List            =   "frmMain.frx":F8CC
         Style           =   2  'Dropdown List
         TabIndex        =   10
         Top             =   240
         Width           =   3135
   ...
   Begin VB.Frame fraSource 
      ...
      Begin VB.ComboBox cboSource 
         Height          =   315
         ItemData        =   "frmMain.frx":F978
         Left            =   120
         List            =   "frmMain.frx":F97A
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   240
...
Private Sub cmdResample_Click()
    ...
    Resample cboResampler.ListIndex, frmDestination.Picture, frmSource.Picture
    frmDestination.Refresh
...
Private Sub Form_Load()
    Dim strFile$
    ' Select first resampler in the list
    cboResampler.ListIndex = 0
